...
# Title
st.markdown("<h1 style='text-align: center; color: hotpink;'>🎉 Happy Birthday Ddidivalu! 🎉</h1>", unsafe_allow_html=True)
...
with col2:
    image3 = Image.open("IMG_5368.PNG")
    st.image(image3, caption="🌸 Puja Celebration", use_container_width=True)

with col3:
    image2 = Image.open("IMG_5367.PNG")
    st.image(image2, caption="🍰 Smiles & Peace", use_container_width=True)
